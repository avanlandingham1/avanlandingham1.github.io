...
img: assets/img/powertrain_2.svg
importance: 1
category: Penn State
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/powertrain_0.svg" title="hybrid" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/powertrain_2.svg" title="hybrid_ecvt" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    On the left, a motor adds power to the main rotor using either a generator or battery in a constant speed configuration. Right, a generator removes and redistributes power from an epicyclic gearbox to vary the rotor speeds. 
</div>
